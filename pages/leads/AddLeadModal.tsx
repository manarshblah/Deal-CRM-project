...
const AddLeadModal: React.FC<AddLeadModalProps> = ({ isOpen, onClose, leadType }) => {
    const { t } = useI18n();

    return (
        <Modal isOpen={isOpen} onClose={onClose} title={t('create_lead')}>
            <form>
